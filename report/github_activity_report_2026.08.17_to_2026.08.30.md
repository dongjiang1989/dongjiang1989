...
|------|------|--------|------|---------|---------|----------|
| 1 | **iflytek/website** | 10 | 5 | 0 | 5 | PR #98: release: v0.6.0; PR #97: docs: update README and fix event type; PR #96: content(events): add Volcano + HAMi-core K |
| 2 | **prometheus-operator/prometheus-operator** | 7 | 5 | 0 | 2 | PR #8770: chore: Update golangci-linter version to; PR #8762: chore: update prometheus version to v3.1; PR #8761: feat: support labels field in Alertmanag |
| 3 | **kubernetes-sigs/controller-tools** | 6 | 3 | 0 | 3 | PR #1470: 🌱 Bump k8s.io/* to v0.37.0; PR #1469: 🌱chore: Bump golangci-lint to v2.13.1; PR #1468: ✨ Release envtest v1.37.0 |
| 4 | **XHToken/community** | 6 | 0 | 0 | 6 | Commit: Update README.md; Commit: Add social media links and WeChat QR code ; Commit: Merge pull request #3 from XHToken/docs/ad |
| 5 | **XHToken/Spark-plugin** | 5 | 3 | 0 | 2 | PR #6: ci: add license compliance check to CI pipe; PR #5: chore: add CHANGELOG.md and PyPI publish wo; PR #1: chore: add project governance and GitHub te |
| 6 | **agentgateway/agentgateway** | 4 | 3 | 0 | 1 | PR #3170: fix(xds): harden leaf cert rotation with; PR #3160: chore: update golangci-lint plugins and ; PR #3064: feat(auth): add RFC 7662 Token Introspec |
| 7 | **kubernetes-sigs/controller-runtime** | 3 | 2 | 0 | 1 | PR #3580: 🌱 Bump to golangci-lint v2.13.1; PR #3579: :seedling: Bump to k8s.io/* v0.37.0; Commit: :seedling: Bump to k8s.io/* v0.37.0 (#3579 |
| 8 | **kubernetes-sigs/agent-sandbox** | 3 | 1 | 0 | 2 | PR #1424: Bump: Update golangci-linter version to ; Commit: refactor(api): move enum validation marker; Commit: Bump: Update golangci-linter version to v2 |
| 9 | **modelcontextprotocol/modelcontextprotocol** | 2 | 1 | 0 | 1 | PR #3309: docs: fix outdated links and incorrect r; Commit: docs: fix outdated links and incorrect rep |
| 10 | **Project-HAMi/HAMi** | 2 | 1 | 0 | 1 | PR #2794: chore: add new linters to golangci-lint ; Commit: chore: add new linters to golangci-lint co |
...
| # | 仓库 | PR | 标题 | 状态 |
|---|------|----|------|------|
| 1 | XHToken/Spark-plugin | [#6](https://github.com/XHToken/Spark-plugin/pull/6) | ci: add license compliance check to CI pipeline | ✅ 已合并 |
| 2 | XHToken/Spark-plugin | [#5](https://github.com/XHToken/Spark-plugin/pull/5) | chore: add CHANGELOG.md and PyPI publish workflow | ✅ 已合并 |
| 3 | XHToken/Spark-plugin | [#1](https://github.com/XHToken/Spark-plugin/pull/1) | chore: add project governance and GitHub templates | ✅ 已合并 |
| 4 | vllm-project/aibrix | [#2630](https://github.com/vllm-project/aibrix/pull/2630) | [CI] Upgrade golangci-lint to v2.13.1 | ✅ 已合并 |
...
- **Commit**: 5 次
- **主要工作**:
  - PR #98: release: v0.6.0
  - PR #97: docs: update README and fix event type
  - PR #96: content(events): add Volcano + HAMi-core K8s meetup (2026-09
  - PR #90: fix(ci): resolve lychee root-relative link errors
  - PR #89: fix(deps): resolve extract-zip path traversal vulnerability 
...
- **Commit**: 2 次
- **主要工作**:
  - PR #8770: chore: Update golangci-linter version to v2.13.1
  - PR #8762: chore: update prometheus version to v3.14.0
  - PR #8761: feat: support labels field in AlertmanagerConfig Route
  - PR #8759: fix(am): Update Alertmanager support external ID version han
  - PR #8758: change: Update alertmanager version to v0.34.0 and change Go
...
- **主要工作**:
  ...
  - Commit: Add social media links and WeChat QR code to README
  - Commit: Merge pull request #3 from XHToken/docs/add-more-social-chan
  - Commit: Merge pull request #2 from XHToken/docs/add-social-channels
  - Commit: Merge pull request #1 from XHToken/dependabot/github_actions

### XHToken/Spark-plugin（5 次活动）

- **PR**: 3 个
- **Commit**: 2 次
- **主要工作**:
  - PR #6: ci: add license compliance check to CI pipeline
  - PR #5: chore: add CHANGELOG.md and PyPI publish workflow
  - PR #1: chore: add project governance and GitHub templates
  - Commit: chore: add CHANGELOG.md and PyPI publish workflow (#5)
  - Commit: chore: add project governance and GitHub templates (#1)
